...
*Figure 1 – Histograms for the differences in the first round (left) and in the second round (right), for all UFs (top) and discriminating the UFs in the NE region from the UFs in the other regions (bottom).*
